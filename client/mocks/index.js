const nameList = ['Snow', 'Jerry', 'Kayne', 'Leon', 'Willy', 'Lay', 'Jason', 'Tim', 'Dan', 'Hiro', 'Brian']
const imageList =[
...
export const getChatroomMessages = () => {
  ...
  const typeList = Object.keys(generator)
  for (let i = 0; i < length; i++) {
    let type = pickOne(typeList)
