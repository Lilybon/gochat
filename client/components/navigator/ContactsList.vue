  ...
  <div>
    <v-list dense class="accent">
      <v-list-item-group color="primary darken-1" v-model="id">
        <v-list-item class="caption pr-0" :value="'add-contact'">
          <v-list-item-icon class="ml-1 mr-6">
            <v-icon color="primary" dense>{{ mdiAccountPlusOutline }}</v-icon>
          </v-list-item-icon>
          <v-list-item-content :class="['border--bottom', id !== 'add-contact' ? 'border--accent-lighten-1' : 'border--transparent']">
        ...
        >
          ...
          <v-list-item-content :class="['border--bottom', id !== contact.id ? 'border--accent-lighten-1' : 'border--transparent']">
